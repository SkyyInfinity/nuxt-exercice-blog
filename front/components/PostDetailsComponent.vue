<template>
    <div class="post relative">
        ...
        <div class="container py-8">
            ...
            <p class="post-details__content text-sm leading-6 opacity-70">{{ post.content }}</p>
        </div>
    </div>
</template>
